variable "cpu_requests_low_perc_enabled" {
  type    = bool
  default = true
}

variable "cpu_requests_low_perc_warning" {
  type    = number
  default = 80
}

variable "cpu_requests_low_perc_critical" {
  type    = number
  default = 95
}
...
variable "cpu_requests_low_perc_alerting_enabled" {
  type    = bool
  default = true
}

variable "cpu_requests_low_perc_no_data_timeframe" {
  type    = number
  default = null
}

variable "cpu_requests_low_perc_notify_no_data" {
  type    = bool
  default = false
}

variable "cpu_requests_low_perc_ok_threshold" {
  type    = number
  default = null
}

variable "cpu_requests_low_perc_priority" {
